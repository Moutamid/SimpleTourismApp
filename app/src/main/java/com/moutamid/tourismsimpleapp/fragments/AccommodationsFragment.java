...
import com.moutamid.tourismsimpleapp.databinding.FragmentAccommodationsBinding;
...
public class AccommodationsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        for (DataModel model : Brain.accommodationsDataArrayList()) {
        ...
        binding.imageSlider.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemSelected(int i) {
                Stash.put(Constants.SAVED_OBJECT, Brain.accommodationsDataArrayList().get(i));
                startActivity(new Intent(requireActivity(), SingleItemActivity.class));
            }
        });

        binding.card1.setOnClickListener(view -> {
            Stash.put(Constants.SAVED_OBJECT, Brain.accommodationsDataArrayList().get(1));
            startActivity(new Intent(requireActivity(), SingleItemActivity.class));
        });

        binding.card2.setOnClickListener(view -> {
            Stash.put(Constants.SAVED_OBJECT, Brain.accommodationsDataArrayList().get(2));
            startActivity(new Intent(requireActivity(), SingleItemActivity.class));
        });
    ...
    private View.OnClickListener listener() {
        return view -> {
            startActivity(new Intent(requireActivity(), AllItemsActivity.class)
                    .putExtra(Constants.PARAMS, Constants.ACCOMMODATIONS));
        };
    }
}